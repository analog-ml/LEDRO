...
if __name__ == "__main__":
    save_folder = ""
    #modelname = "ibm_bam/ibm/granite-13b-chat-v2"
    #modelname = "ibm_bam/ibm-meta/llama-2-70b-chat-q"
    modelname = "ibm_bam/meta-llama/llama-3-70b-instruct"
    has_examples = False
    tester = QaTester(save_folder, modelname, True)
    convid = tester.mc_tester("/path/to/LLM/sample-qa-data_i.json", "/path/to/LLM/qa_output_amp_l.txt")
