...
if __name__ == '__main__':
    ...
    yname = '/afs/apd.pok.ibm.com/func/vlsi/eclipz/l14/usr/username/aidd0/rlm/zeus2/past_codes/AutoCkt_spectre/spectre_simulator/spectre/specs_list_read/vanilla_two_stage_opamp.yaml'
